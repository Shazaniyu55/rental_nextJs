...
export const signUp = createAsyncThunk(
  ...
  async (values: signUpDetails) => {
    try {
      const res = await axios({
        method: "POST",
        url: `${process.env.RENTALS_URL}api/users/signup`,
        data: values,
      });
      const data = await res.data;
...
export const login = createAsyncThunk("users/login", async (values: any) => {
  try {
    const res = await axios({
      method: "POST",
      url: `${process.env.RENTALS_URL}api/users/login`,
      data: values,
    });
    const data = await res.data;
    return data;
...
export const changePassword = createAsyncThunk(
  ...
  async (values: any) => {
    try {
      const res = await axios({
        method: "POST",
        url: `${process.env.RENTALS_URL}api/sw-dashboard/change-password`,
        data: values,
      });
      const data = await res.data;
      return data;
...
export const changePasswordWithPhone = createAsyncThunk(
  ...
  async (values: any) => {
    try {
      const res = await axios({
        method: "POST",
        url: `${process.env.RENTALS_URL}api/users/change-password`,
        data: values,
      });
      const data = await res.data;
      return data;
