  ...
  return (
    ...
    >
      ...
      <ListItemButton sx={{ ml: 0 }} onClick={accountHandleClick}>
        <ListItemIcon>
          <AccountCircleIcon sx={{ color: theme.rent[1000] }} />
        </ListItemIcon>
        <ListItemText
      ...
      <Collapse in={openAccount} timeout="auto" unmountOnExit>
        <List component="div">
          <ListItemButton onClick={profileHandleClick} sx={{ ml: 0 }}>
            <ListItemIcon>
              <PersonIcon sx={{ color: theme.rent[1000] }} />
            </ListItemIcon>
      ...
      <Collapse in={openJob} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          ...
          >
            {" "}
            <ListItemIcon>
              <StayCurrentPortraitIcon sx={{ color: theme.rent[1000] }} />
            </ListItemIcon>
            <ListItemText
          ...
          >
            <ListItemIcon>
              <AssignmentTurnedInIcon sx={{ color: theme.rent[1000] }} />
            </ListItemIcon>
            <ListItemText
...
export function ChangePassword({ router }: any) {
  return (
    ...
    >
      {" "}
      <ListItemIcon>
        <SettingsIcon sx={{ color: theme.rent[1000] }} />
      </ListItemIcon>
      <ListItemText
...
export function LiveChat() {
  ...
  return (
    ...
    >
      <ListItemIcon>
        <ContactSupportIcon sx={{ color: theme.rent[1000] }} />
      </ListItemIcon>
      <ListItemText
...
export function Catalog({ router }: any) {
  return (
    ...
    >
      {" "}
      <ListItemIcon>
        <CollectionsIcon sx={{ color: theme.rent[1000] }} />
      </ListItemIcon>
      <ListItemText
  ...
  return (
    <>
      <ListItemButton sx={{ ml: 0 }} onClick={openVerificationHandleClick}>
        {" "}
        <ListItemIcon>
          <WorkspacePremiumIcon sx={{ color: theme.rent[1000] }} />
        </ListItemIcon>{" "}
        <ListItemText
      ...
      <Collapse in={openVerification} timeout="auto" unmountOnExit>
        <List component="div">
          ...
          >
            <ListItemIcon>
              <PermIdentityIcon sx={{ color: theme.rent[1000] }} />
            </ListItemIcon>
            <ListItemText
          ...
          >
            <ListItemIcon>
              <AdminPanelSettingsIcon sx={{ color: theme.rent[1000] }} />
            </ListItemIcon>
            <ListItemText
